...
const extraMetadata = {
  external_url: "https://humanoidbird.xyz", // Replace with your website or remove this line if you do not have one.
};
...
const PRESALE_WHITELISTED_ADDRESSES = ["0x3ed06815F9cCED8eB6B080407f49CBdE52914EfC"]; // only update if you want to manually set the whitelisted addresses
